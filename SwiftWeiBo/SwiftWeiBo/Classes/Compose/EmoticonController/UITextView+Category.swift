...
extension UITextView
{
    func insertEmoticons(emoticon : Emoticon){
        ...
        }else if emoticon.png != nil
        {
            ...
            let imgText = EmoticonTextAttachment.createImageText(emoticon, font: font ?? UIFont.systemFontOfSize(15))
            //拿到textView content
            ...
            textViewStr.addAttribute(NSFontAttributeName, value: font ?? UIFont.systemFontOfSize(15), range: NSMakeRange(range.location, 1))
            //替换 textView content
